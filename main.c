...
/*   Updated: 2023/01/15 14:45:22 by yakhay           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void anime(t_solong *khay , int x, int y)
{
    ...
    if (khay->t == 9)
    {
        if ((khay->str[x][y+1] == '0' || khay->str[x][y+1] == 'P'))
        {
            khay->str[x][y] = '0';
                khay->k +=1;
                if ( khay->str[x][y+1] == 'P')
        ...
        else if ((khay->str[x][y-1] == '0' || khay->str[x][y-1] == 'P'))
        {
                khay->str[x][y] = '0';
            if (khay->str[x][y-1] == 'P')
                exit(0);
...
int key(t_solong *khay)
{
    ...
    if (khay->t <= 8)
        khay->t +=1;
    anime(khay ,ft_sersh_playr(khay->str,0,'M'), ft_sersh_playr(khay->str,1,'M'));
    ft_afichage(khay);
    return 0;
}
void so_long(char **str)
{
    ...
    khay.mons= mlx_xpm_file_to_image(khay.mlx, "./monster.xpm", &(khay.img_width), &(khay.img_height));
    khay.vec =  mlx_xpm_file_to_image(khay.mlx, "./vector.xpm", &(khay.img_width), &(khay.img_height));
